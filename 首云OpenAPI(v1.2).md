...
| data | dict | {} | 返回数据  |
| Total      | int      | 11                                   | NAT总数     |
| NATList    | list     | []                                   | NAT信息列表 |
| Id      | string   | 9304b130-e25b-11ec-a12c-823092f7a5bd    | NAT ID      |
| Name    | string   | test                                    | NAT名称     |
| Status     | string   | ok                                   | NAT状态     |
| RegionCode | string   | CN_Hongkong                          | NAT区域code |
| AvailableZoneCode | string   | CN_Hongkong_A                 | NAT可用区code |
| Description | string   | 测试                         | NAT描述     |
| VPCId | string | 9304b130-e25b-11ec-a12c-823092f7a5bd                  | 所属VPCID    |
| SpecificationId | int | 1234                  | NAT规格    |
| BillingMethod | int | 0                | 0: 按需， 1: 包月    |
...
```json
{
    ...
    "Data": {
        "NATList": [
            {
                "AvailableZoneCode": "US_Dallas_N",
                "BillingMethod": 0,
                "Description": "ttt",
                "Id": "7c7f044a-7819-11f0-8a46-8a59e945c9c2",
                "Name": "tt",
                "RegionCode": "US_Dallas",
                "SpecificationId": 12914,
                "Status": "ok",
                "VPCId": "7c7f044a-7819-11f0-8a46-8a59e945c9c2"
            }
        ],
        "Total": 2
    },
